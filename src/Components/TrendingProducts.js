  ...
  <CardGroup className='group' style={{border:'none'}}>
      ...
      <Card className='single-card' style={{border:'none',borderRadius:'5px'}}>
        ...
        <div className='image-container'>
          <Link to={'/single-view1'}>
          <Card.Img className='image' src={frame1} />
          </Link></div>
        <Card.Body>
          <p>Artograph</p>
          <Link to={'/single-view1'} style={{textDecoration:'none'}}>
          <Card.Text className='description'>
          Moments photo frame with costomised photos
          </Card.Text>
          
          <p>Black,16 photos</p></Link>
          <div className='rate'>
            <h4><BiRupee/>497</h4>
            <button>Add +</button>
          </div>
