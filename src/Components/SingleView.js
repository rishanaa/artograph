            ...
            <Row>
              <Col md-6>
                <div className="aa">
                  ...
                  <div
                    className="col-md-3 col-lg-2 col-xl-2 d-flex counter"
                    style={{
              ...
              <Col md-6>
                ...
                <h3 style={{ color: "#b60d5d", marginTop: "15px" }}>
                  <BiRupee />
                  {productDetail?.price}
                </h3>
                ...
                <div className="login-html" style={{ marginTop: "5px" }}>
                  ...
                  <div class="login-form">
                    ...
                    <div className="sign-up-htm">
                      <p>
                        This product comes with customised images,and you can
                        attach images as per your choice
                      </p>
                    </div>
                  </div>
                </div>
